...
export default function AddBusinessOwner(){
    ...
    <form  className="Studentform" >
        <h1 style={{textAlign:'center'}}>Add Business Owner</h1>
    ...
    <div className = "inputBox">
        ...
        <input className="size" type="text" name = 'Brand_Name' placeholder="Optional.." onChange={handleChange}/>
    </div>
    <div className = "inputBox">
        <label>Brand Type:</label>
        <input className="size" type="text" name = 'Brand_Type:' placeholder="Optional.." onChange={handleChange}/>
    </div>
