...
export default function AddClub(){
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('http://localhost:80/api/clubs.php/', inputs).then(function(response){
    ...
    <form  className="Studentform" >
        <h1 style={{textAlign:'center'}}>Add User to Club</h1>
    <div className="inputBox">
        <label>Club Name</label>
        <input className="size" type="text" name = 'ClubName' placeholder="eg: Basket_Ball" onChange={handleChange}/>
    </div>
    <div className="inputBox">
        <label>User Name</label>
        <input className="size" type="text" name = 'Username' placeholder="eg: Henry" onChange={handleChange}/>
    </div>
