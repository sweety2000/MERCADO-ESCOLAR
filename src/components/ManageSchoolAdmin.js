...
export default function ManageSchoolAdmin() {
    ...
    const handleSubmit = (event) => {
        ...
        <a href="/Cart">
                ...
                <div class="col-2">
                    <h1 class="service">Manage SchoolAdmins</h1>
                </div>
                <div>
                    <div class="row">
                        <div class="col-2">
                            ...
                            <div class="box">
                                ...
                                <div className="signupform" onSubmit={handleSubmit}>
                                    <form action="" className="Loginform">
                                        <h1 style={{textAlign:'center'}}>Search School Admin</h1>
                        ...
                        <div class="row">
                            <div class="profile">
                                <img src="assests/images/admin.jpg" width="300" height="300" />
